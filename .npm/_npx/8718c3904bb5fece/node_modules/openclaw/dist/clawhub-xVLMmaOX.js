	...
	try {
		return {
			response: await (params.fetchImpl ?? fetch)(url, {
				headers: params.token ? { Authorization: `Bearer ${params.token}` } : void 0,
...
async function listClawHubSkills(params) {
	return await fetchJson({
		baseUrl: params.baseUrl,
		path: "/api/v1/skills",
		token: params.token,
		timeoutMs: params.timeoutMs,
		fetchImpl: params.fetchImpl,
		search: { limit: params.limit ? String(params.limit) : void 0 }
	});
}
...
//#endregion
export { fetchClawHubPackageVersion as a, parseClawHubPluginSpec as c, satisfiesGatewayMinimum as d, satisfiesPluginApiRange as f, fetchClawHubPackageDetail as i, resolveClawHubBaseUrl as l, downloadClawHubPackageArchive as n, fetchClawHubSkillDetail as o, searchClawHubSkills as p, downloadClawHubSkillArchive as r, listClawHubSkills as s, ClawHubRequestError as t, resolveLatestVersionFromPackage as u };
