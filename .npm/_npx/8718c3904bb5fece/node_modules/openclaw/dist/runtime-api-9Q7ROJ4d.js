import { Uy as listEnabledDiscordAccounts, Vy as createDiscordActionGate, qt as handleDiscordMessageAction } from "./pi-embedded-CzQCqSlH.js";
import { a as listTokenSourcedAccounts, i as createUnionActionGate, l as stringEnum } from "./channel-actions-BzT1SAu9.js";
...
function describeDiscordMessageTool({ cfg }) {
	...
	return {
		...
		schema: { properties: { components: createDiscordMessageToolComponentsSchema() } }
	};
}
