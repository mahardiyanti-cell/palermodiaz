...
import { a as DmPolicySchema, c as GroupPolicySchema, m as MarkdownConfigSchema } from "./zod-schema.core-yLTNC4-K.js";
import { $_ as mapAllowFromEntries, F_ as createChatChannelPlugin, H_ as adaptScopedAccountAccessor, J_ as createScopedDmSecurityResolver, K_ as createScopedChannelConfigAdapter, N_ as buildChannelOutboundSessionRoute, Pv as createOpenProviderGroupPolicyWarningCollector, R_ as stripChannelTargetPrefix, _v as buildOpenGroupPolicyRestrictSendersWarning, vv as buildOpenGroupPolicyWarning, x_ as formatAllowFromLowercase, z_ as stripTargetKindPrefix } from "./pi-embedded-CzQCqSlH.js";
...
import { c as jsonResult, h as readStringParam } from "./common-De-BVwIv.js";
import { n as buildCatchallMultiAccountChannelSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-Bpwy_blm.js";
...
import { Y as createStaticReplyToModeResolver } from "./conversation-runtime-CqOm9f5F.js";
import { a as createEmptyChannelResult, o as createRawChannelSendResultAdapter } from "./channel-send-result-BUHt3vEX.js";
import { l as isNumericTargetId, y as sendPayloadWithChunkedTextAndMedia } from "./reply-payload-MXtGsVoh.js";
import { i as createLazyRuntimeNamedExport, r as createLazyRuntimeModule } from "./lazy-runtime-szmmmzbU.js";
import { d as listResolvedDirectoryUserEntriesFromAllowFrom, p as createChannelDirectoryAdapter } from "./directory-runtime-Dv9ukfmB.js";
import { t as extractToolSend } from "./tool-send-BGw_CwhP.js";
import { i as coerceStatusIssueAccountId, o as readStatusIssueFields } from "./extension-shared-BLlTRQdf.js";
import { n as zaloSetupAdapter, t as zaloSetupWizard } from "./zalo-DMmuqohC.js";
import { i as resolveZaloAccount, n as listZaloAccountIds, r as resolveDefaultZaloAccountId, t as listEnabledZaloAccounts } from "./accounts-LRup6u79.js";
import { t as chunkTextForOutbound } from "./text-chunking-Drx30q_G.js";
import { z } from "zod";
//#region extensions/zalo/src/actions.ts
const loadZaloActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-FL9TwS2n.js"), "zaloActionsRuntime");
...
const loadZaloChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-ant0MHH0.js"));
