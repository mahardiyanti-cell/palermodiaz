...
import { d as readConfigFileSnapshot, g as writeConfigFile, v as validateConfigObjectRaw } from "./io-cPs4dU7X.js";
import "./host-env-security-DEKL50zA.js";
import "./shell-env-BKuVS72k.js";
import "./safe-text-DIDDfQyI.js";
import "./version-BpHNkJed.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-DiT8-OyD.js";
...
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-CJXmIbG8.js";
import { C as SecretProviderSchema } from "./zod-schema.core-yLTNC4-K.js";
import "./config-CB4aYWqd.js";
import "./audit-fs-CEN00XrG.js";
import { a as resolveSecretRefValue } from "./resolve-uXRpJb-M.js";
import { t as formatCliCommand } from "./command-format-DRptdHvm.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-CP-gqjZB.js";
import { t as OLLAMA_DEFAULT_BASE_URL } from "./ollama-defaults--y6cuBln.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-Che-i6sL.js";
import "./timeouts-DqgpCWVw.js";
import "./timeouts-BW5SSenu.js";
import { t as redactConfigObject } from "./redact-snapshot-D0SkeT2k.js";
import { n as setCommandJsonMode } from "./json-mode-rAItmOXZ.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-D68dkOqs.js");
