...
import { Ah as listTelegramAccountIds, Av as createAllowlistProviderRouteAllowlistWarningCollector, C as monitorTelegramProvider, Ch as buildTelegramGroupPeerId, E as buildTelegramExecApprovalButtons, F_ as createChatChannelPlugin, I_ as defineChannelPluginEntry, Nh as resolveTelegramAccount, Qc as parseTelegramTopicConversation, S as probeTelegram, Sh as listTelegramDirectoryPeersFromConfig, Yp as collectTelegramStatusIssues, _h as isTelegramExecApprovalClientEnabled, ah as looksLikeTelegramTargetId, gm as sendTypingTelegram, ih as parseTelegramThreadId, im as sendTelegramPayloadMessages, mg as resolveExecApprovalCommandDisplay, mh as resolveTelegramGroupToolPolicy, oh as normalizeTelegramMessagingTarget, ph as resolveTelegramGroupRequireMention, rh as parseTelegramReplyToMessageId, ug as buildExecApprovalPendingReplyPayload, vh as resolveTelegramExecApprovalTarget, xh as listTelegramDirectoryGroupsFromConfig, yh as parseTelegramTarget } from "./pi-embedded-CzQCqSlH.js";
...
import { t as clearAccountEntryFields } from "./channel-plugin-common-COvcxNrG.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-I2-dQl_4.js";
import { l as createComputedAccountStatusAdapter, o as buildTokenChannelStatusSummary, u as createDefaultChannelRuntimeState } from "./status-helpers-Dd-hr4j4.js";
import { t as attachChannelToResult } from "./channel-send-result-BUHt3vEX.js";
...
import { n as collectTelegramUnmentionedGroupIds, t as auditTelegramGroupMembership } from "./audit-CO95QNfX.js";
import { t as createPluginRuntimeStore } from "./runtime-store-CPgyMOrt.js";
import { c as createNestedAllowlistOverrideResolver, n as buildDmGroupAccountAllowlistAdapter } from "./allowlist-config-edit-BLfgl27j.js";
import { a as telegramSetupWizard, i as telegramConfigAdapter, n as findTelegramTokenOwnerAccountId, o as telegramSetupAdapter, r as formatDuplicateTelegramTokenReason, t as createTelegramPluginBase } from "./shared-BRv5Kn2w.js";
		...
		lifecycle: {
			onAccountConfigChanged: async ({ prevCfg, nextCfg, accountId }) => {
				if (resolveTelegramAccount({
					...
					const { deleteTelegramUpdateOffset } = await import("./update-offset-store-EsQ8iqm7.js");
