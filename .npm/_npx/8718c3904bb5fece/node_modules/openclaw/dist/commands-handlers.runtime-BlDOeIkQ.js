...
import { v as resolveSessionAgentId } from "./agent-scope-DoT9OqaV.js";
import "./model-selection-B6ao45a4.js";
import { A as getConfigOverrides, F as parseConfigPath, I as setConfigValueAtPath, L as unsetConfigValueAtPath, M as setConfigOverride, N as unsetConfigOverride, P as getConfigValueAtPath, b as validateConfigObjectWithPlugins, d as readConfigFileSnapshot, g as writeConfigFile, j as resetConfigOverrides } from "./io-cPs4dU7X.js";
...
import { s as normalizeChannelId } from "./registry-xyHjVLxh.js";
import "./config-state-Dx9-tLPS.js";
import "./min-host-version-xbc6BJ_K.js";
import { t as clearPluginManifestRegistryCache } from "./manifest-registry-D5E7Gxgl.js";
import "./runtime-guard-QGt7fm0l.js";
import "./avatar-policy-DVf9B9eu.js";
import "./ip-DIgtRRTW.js";
import { t as parseDurationMs } from "./parse-duration-bHXUj_T0.js";
...
import { a as isInternalMessageChannel, h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES } from "./message-channel-DUrzQUcI.js";
import { l as updateSessionStore, n as loadSessionStore } from "./store-D_eNuCKK.js";
import "./runtime-C8dQugND.js";
import { s as getChannelPlugin } from "./plugins-DGdgUNcN.js";
import "./sessions-C8WesgCl.js";
import { i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BPfguEtH.js";
import { a as resolveFreshSessionTotalTokens } from "./types-ugjRm8gv.js";
import "./session-write-lock-bE2vQvvO.js";
import "./method-scopes-BWG4Q18M.js";
import { n as callGateway } from "./call-VZCb020X.js";
...
import { r as isRestartEnabled, t as isCommandFlagEnabled } from "./commands-CrPoYX9r.js";
import "./issue-format-CP-gqjZB.js";
import "./help-format-BW49iAcY.js";
import "./memory-cli-PrIR2Lrr.js";
import "./identity-D8H54Ni5.js";
import "./heartbeat-FZaB85hC.js";
import { $a as formatRunLabel, $d as createExecTool, $f as isTtsEnabled, Aa as handleStatusCommand, Ay as EmbeddedBlockChunker, Bg as isAbortTrigger, Bv as authorizeConfigWrite, Ca as requireCommandFlagEnabled, Da as handleContextCommand, Ea as handleCommandsListCommand, Ec as listSubagentRunsForController, Ff as formatContextUsageShort, Ga as buildSubagentList, Gv as resolveAcpSessionCwd, Hf as formatTokenCount$1, Hv as formatConfigWriteDeniedMessage, If as formatTokenCount, Ip as executePluginCommand, Jv as isAcpEnabledByPolicy, Ka as killAllControlledSubagentRuns, Kv as resolveAcpSessionIdentifierLinesFromIdentity, Ly as ensureOpenClawModelsJson, Oa as handleExportSessionCommand, Ou as scheduleGatewaySigusr1Restart, P as getApiKeyForModel, Qa as formatDurationCompact, Qf as isSummarizationEnabled, R as requireApiKey, Rp as matchPluginCommand, Sa as rejectUnauthorizedCommand, Uf as formatUsd, Vc as clearSessionQueues, Vg as setAbortMemory, Vv as canBypassConfigWritePolicy, Wd as resolveFastModeState, Wv as resolveConfigWriteTargetFromPath, Xa as sendControlledSubagentMessage, Xf as getTtsMaxLength, Xv as resolveAcpDispatchPolicyError, Yf as getLastTtsAttempt, Yv as resolveAcpAgentPolicyError, Za as steerControlledSubagentRun, Zf as getTtsProvider, Zv as resolveAcpDispatchPolicyMessage, _ as stripToolResultDetails, _c as stopSubagentsForRequester, _h as isTelegramExecApprovalClientEnabled, a as isEmbeddedPiRunActive, ba as buildDisabledCommandReply, bc as countPendingDescendantRuns, bf as getSession, bp as normalizeSpeechProviderId, cd as stripToolMessages, co as cleanupFailedAcpSpawn, ep as isTtsProviderConfigured, ff as killProcessTree, fp as setTtsEnabled, gc as resolveSessionEntryForKey, gh as isTelegramExecApprovalApprover, gp as textToSpeech, hc as formatAbortReplyText, hl as formatElevatedUnavailableMessage, i as getActiveEmbeddedRunSnapshot, ip as resolveTtsApiKey, ja as handleWhoamiCommand, jp as resolveModelWithRegistry, ju as triggerOpenClawRestart, ka as handleHelpCommand, l as waitForEmbeddedPiRunEnd, lp as setLastTtsAttempt, mp as setTtsProvider, n as abortEmbeddedPiRun, no as sortSubagentRuns, op as resolveTtsConfig, p as mapThinkingLevel, pc as extractBtwQuestion, pp as setTtsMaxLength, qa as killControlledSubagentRun, qv as resolveAcpThreadSessionDetailLines, ro as spawnSubagentDirect, so as resolveAcpSpawnRuntimePolicyError, sp as resolveTtsPrefsPath, u as compactEmbeddedPiSession, up as setSummarizationEnabled, va as handleModelsCommand, vp as getSpeechProvider, wa as requireGatewayClientScopeForInternalChannel, xa as rejectNonOwnerCommand, xf as markExited, xl as parseActivationCommand, yf as getFinishedSession } from "./pi-embedded-CzQCqSlH.js";
import { d as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-D4lZfNM5.js";
...
import { P as resolveSandboxRuntimeStatus } from "./sandbox-C3lR2qEl.js";
...
import { r as setPluginEnabledInConfig } from "./provider-web-search-DYdDI2c9.js";
import { b as toAcpRuntimeError, c as parseRuntimeTimeoutSecondsInput, d as validateRuntimeModeInput, f as validateRuntimeModelInput, h as resolveAcpSessionResolutionError, i as getAcpRuntimeBackend, l as validateRuntimeConfigOptionInput, n as readAcpSessionEntry, o as requireAcpRuntimeBackend, p as validateRuntimePermissionProfileInput, r as resolveSessionStorePathForAcp, t as getAcpSessionManager, u as validateRuntimeCwdInput } from "./manager-CTkU8M9E.js";
import "./config-schema-Bpwy_blm.js";
import "./channel-plugin-common-COvcxNrG.js";
import "./status-helpers-Dd-hr4j4.js";
import { W as getSessionBindingService, i as resolveThreadBindingThreadName, r as resolveThreadBindingIntroText, t as formatThreadBindingDurationLabel } from "./conversation-runtime-CqOm9f5F.js";
import "./runtime-whatsapp-boundary-CWceJs-_.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-ClZkWB4v.js";
...
import { a as resolveArchiveKind } from "./archive-Bk8HKpaY.js";
...
import { t as diag } from "./diagnostic-PF4suwLJ.js";
import "./templating-BueU7auS.js";
import "./channel-reply-pipeline-C0iCnI2R.js";
import { _ as stripStructuralPrefixes, g as stripMentions } from "./reply-history-BVE7m0XA.js";
import "./commands-registry.data-Dr5wKe-o.js";
import { p as normalizeCommandBody } from "./commands-registry-C-vLUx3f.js";
...
import { c as resolveSessionAuthProfileOverride } from "./level-overrides-DoL5t4pG.js";
...
import { d as resolveThreadBindingSpawnPolicy, i as formatThreadBindingSpawnDisabledError, r as formatThreadBindingDisabledError, s as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingMaxAgeMsForChannel } from "./thread-bindings-policy-9hlYF-wX.js";
...
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-BpWH93Dy.js";
...
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-BsfiHe-6.js";
...
import { n as createPluginRuntime } from "./runtime-56qOLePE.js";
import "./audit-EvVP3T74.js";
import "./runtime-api-9Q7ROJ4d.js";
import "./route-resolution-CRjhQ-X0.js";
import "./thread-bindings.messages-TP9SUuUL.js";
import "./provider-CmA0Hwes.js";
import "./timeouts-DqgpCWVw.js";
import "./message-handler-DnFbV1mF.js";
import "./thread-bindings-r8BO6n9H.js";
import "./ui-Ct7fSJa7.js";
import "./src-PBF8suXB.js";
import "./resolve-users-CZ4wEiHp.js";
import "./resolve-channels-BCqJVzVS.js";
import "./timeouts-BW5SSenu.js";
import "./discord-BYsj7jeZ.js";
import "./imessage-CSS2xDUy.js";
import "./process-runtime-8YfSZ5xw.js";
import { n as incrementCompactionCount } from "./session-updates-3pCkm0V_.js";
...
import { t as formatAcpRuntimeErrorText } from "./error-text-BHYusstJ.js";
import { t as parseConfigValue } from "./config-value-D8Ad0Iav.js";
import "./install-source-utils-L4jI7Syn.js";
import { a as buildPreferredClawHubSpec, c as decidePreferredClawHubFallback, m as buildNpmInstallRecordFields, n as persistPluginInstall, p as resolveFileNpmSpecToLocalPath, s as createPluginInstallLogger } from "./plugins-install-persist-daoXRUwr.js";
import { c as parseClawHubPluginSpec } from "./clawhub-xVLMmaOX.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./installs-XLSjUYkq.js";
import { r as installPluginFromClawHub } from "./clawhub-BprlOTz-.js";
import { a as buildPluginStatusReport, i as buildPluginInspectReport, o as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-DE_JvlNY.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-LRr0F0Ln.js";
