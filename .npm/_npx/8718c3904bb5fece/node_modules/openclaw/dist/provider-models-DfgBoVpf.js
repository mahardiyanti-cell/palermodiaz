...
import { m as resolveAllowlistModelKey } from "./model-selection-B6ao45a4.js";
import { C as KILOCODE_MODEL_CATALOG, _ as KILOCODE_DEFAULT_CONTEXT_WINDOW, b as KILOCODE_DEFAULT_MODEL_ID, g as KILOCODE_BASE_URL, v as KILOCODE_DEFAULT_COST, x as KILOCODE_DEFAULT_MODEL_NAME, y as KILOCODE_DEFAULT_MAX_TOKENS } from "./provider-model-minimax-XdwKeUOE.js";
import { t as applyAgentDefaultPrimaryModel } from "./provider-model-primary-HPuNDciv.js";
...
//#endregion
export { isReasoningModelHeuristic as $, TOGETHER_MODEL_CATALOG as A, buildChutesModelDefinition as B, VENICE_DEFAULT_MODEL_REF as C, resolveRetryConfig as D, discoverVeniceModels as E, buildSyntheticModelDefinition as F, buildHuggingfaceModelDefinition as G, discoverKilocodeModels as H, CHUTES_BASE_URL as I, OLLAMA_DEFAULT_COST as J, discoverHuggingfaceModels as K, CHUTES_DEFAULT_MODEL_ID as L, SYNTHETIC_BASE_URL as M, SYNTHETIC_DEFAULT_MODEL_REF as N, retryAsync as O, SYNTHETIC_MODEL_CATALOG as P, fetchOllamaModels as Q, CHUTES_DEFAULT_MODEL_REF as R, VENICE_BASE_URL as S, buildVeniceModelDefinition as T, HUGGINGFACE_BASE_URL as U, discoverChutesModels as V, HUGGINGFACE_MODEL_CATALOG as W, buildOllamaModelDefinition as X, OLLAMA_DEFAULT_MAX_TOKENS as Y, enrichOllamaModelsWithContext as Z, BYTEPLUS_BASE_URL as _, ensureModelAllowlistEntry as _t, SGLANG_DEFAULT_BASE_URL as a, GOOGLE_GEMINI_DEFAULT_MODEL as at, BYTEPLUS_MODEL_CATALOG as b, VLLM_DEFAULT_API_KEY_ENV_VAR as c, OPENAI_DEFAULT_EMBEDDING_MODEL as ct, VLLM_PROVIDER_LABEL as d, OPENAI_DEFAULT_TTS_MODEL as dt, resolveOllamaApiBase as et, DOUBAO_BASE_URL as f, OPENAI_DEFAULT_TTS_VOICE as ft, buildDoubaoModelDefinition as g, applyOpenAIConfig as gt, DOUBAO_MODEL_CATALOG as h, applyGoogleGeminiModelDefault as ht, SGLANG_DEFAULT_API_KEY_ENV_VAR as i, OPENCODE_ZEN_DEFAULT_MODEL_REF as it, buildTogetherModelDefinition as j, TOGETHER_BASE_URL as k, VLLM_DEFAULT_BASE_URL as l, OPENAI_DEFAULT_IMAGE_MODEL as lt, DOUBAO_CODING_MODEL_CATALOG as m, OPENCODE_ZEN_DEFAULT_MODEL$1 as mt, VERCEL_AI_GATEWAY_BASE_URL as n, buildCloudflareAiGatewayModelDefinition as nt, SGLANG_MODEL_PLACEHOLDER as o, OPENAI_CODEX_DEFAULT_MODEL as ot, DOUBAO_CODING_BASE_URL as p, OPENCODE_GO_DEFAULT_MODEL_REF as pt, OLLAMA_DEFAULT_CONTEXT_WINDOW as q, discoverVercelAiGatewayModels as r, resolveCloudflareAiGatewayBaseUrl as rt, SGLANG_PROVIDER_LABEL as s, OPENAI_DEFAULT_AUDIO_TRANSCRIPTION_MODEL as st, buildKilocodeModelDefinition as t, CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF as tt, VLLM_MODEL_PLACEHOLDER as u, OPENAI_DEFAULT_MODEL as ut, BYTEPLUS_CODING_BASE_URL as v, VENICE_MODEL_CATALOG as w, buildBytePlusModelDefinition as x, BYTEPLUS_CODING_MODEL_CATALOG as y, CHUTES_MODEL_CATALOG as z };
