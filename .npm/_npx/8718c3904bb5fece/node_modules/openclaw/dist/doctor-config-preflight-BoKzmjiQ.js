...
import { d as readConfigFileSnapshot, x as OpenClawSchema } from "./io-cPs4dU7X.js";
import { n as formatConfigIssueLines } from "./issue-format-CP-gqjZB.js";
import { t as note } from "./note-DFCwFXVH.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BvK-yZ7-.js");
