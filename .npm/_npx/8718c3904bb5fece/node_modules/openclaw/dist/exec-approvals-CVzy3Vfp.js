...
import { H as validateSafeBinArgv, K as analyzeShellCommand, Q as splitCommandChain, X as isWindowsPlatform, bt as SAFE_BIN_PROFILES, dt as isShellWrapperExecutable, et as matchAllowlist, ht as resolveInlineCommandMatch, it as resolveCommandResolutionFromArgv, lt as extractShellWrapperInlineCommand, nt as resolveAllowlistCandidatePath, ot as resolveExecWrapperTrustPlan, pt as POSIX_INLINE_COMMAND_FLAGS, vt as normalizeExecutableToken, yt as DEFAULT_SAFE_BINS, z as isTrustedSafeBinPath } from "./io-cPs4dU7X.js";
...
function resolveShellWrapperPositionalArgvCandidatePath(params) {
	...
	if (!/(?:^|[^\\$])\$(?:0|\{0\})/.test(inlineMatch.command)) return;
	...
	return resolveAllowlistCandidatePath(resolveCommandResolutionFromArgv([carriedExecutable], params.cwd, params.env), params.cwd);
}
