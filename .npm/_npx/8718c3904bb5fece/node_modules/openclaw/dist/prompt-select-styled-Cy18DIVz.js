...
import { d as resolveProfileUnusableUntilForDisplay, h as repairOAuthProfileIdMismatch, m as resolveApiKeyForProfile } from "./auth-profiles-CVFpgeL-.js";
...
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-DoT9OqaV.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CyhDhBAD.js";
import { _ as resolveHooksGmailModel, a as getModelRefStatus, h as resolveConfiguredModelRef } from "./model-selection-B6ao45a4.js";
import { At as normalizeTalkSection, Ot as DEFAULT_TALK_PROVIDER, R as getTrustedSafeBinDirs, U as listRiskyConfiguredSafeBins, V as normalizeTrustedSafeBinDirs, d as readConfigFileSnapshot, g as writeConfigFile, it as resolveCommandResolutionFromArgv, z as isTrustedSafeBinPath } from "./io-cPs4dU7X.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-DiT8-OyD.js";
import { A as resolveSlackNativeStreaming, D as formatSlackStreamingBooleanMigrationMessage, E as formatSlackStreamModeMigrationMessage, M as resolveTelegramPreviewStreamMode, j as resolveSlackStreamingMode, k as resolveDiscordPreviewStreamMode } from "./zod-schema.providers-core-DLPfih2y.js";
import { n as migrateLegacyWebSearchConfig } from "./legacy-web-search-CTvir-Bl.js";
import { c as normalizeChatChannelId } from "./registry-xyHjVLxh.js";
import { n as parseToolsBySenderTypedKey, r as migrateLegacyConfig } from "./config-CB4aYWqd.js";
import { t as describeUnknownError } from "./shared-DdkyTlo8.js";
import { c as ensureAuthProfileStore, m as updateAuthProfileStoreWithLock } from "./profiles-Cyg58FCO.js";
...
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-DDyo7wy3.js";
...
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-CVVi4ED4.js";
import { d as resolveGatewayBindHost, r as isLoopbackHost } from "./net-Dk658jWW.js";
import { a as resolveGatewayAuth } from "./auth-C_pTuZtn.js";
import { d as readGatewayTokenEnv } from "./credentials-CO55Yx_u.js";
import { n as loadSessionStore } from "./store-D_eNuCKK.js";
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-BJKqY_tB.js";
import { c as listChannelPlugins } from "./plugins-DGdgUNcN.js";
import { i as resolveMainSessionKey } from "./main-session-Dw8Q-wqf.js";
import { i as resolveAgentSessionDirs } from "./sessions-C8WesgCl.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BPfguEtH.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-bE2vQvvO.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-VZCb020X.js";
import { f as printWizardHeader, m as randomToken, n as applyWizardMetadata, s as guardCancel } from "./onboard-helpers-Cks5EPpw.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-DoeW56DL.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-MhFLSlua.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-DDdD9wdn.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-s9kmDqmL.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-CQIuVpXl.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-CLf_Dm5l.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-DgwDJssp.js";
import { n as formatConfigIssueLines } from "./issue-format-CP-gqjZB.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-CrDxbYAe.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-t9hOyCMp.js";
import { Af as buildBootstrapInjectionStats, Ah as listTelegramAccountIds, Dy as resolveBootstrapMaxChars, Ef as resolveBootstrapContextForRun, M as hasConfiguredMemorySecretInput, Nh as resolveTelegramAccount, Ny as loadModelCatalog, Oh as inspectTelegramAccount, Oy as resolveBootstrapTotalMaxChars, Th as lookupTelegramChatId, ft as resolvePluginProviders, gu as resolveCommandSecretRefsViaGateway, kf as analyzeBootstrapBudget, lg as applyPluginAutoEnable, pt as loadOpenClawPlugins, z as resolveApiKeyForProvider } from "./pi-embedded-CzQCqSlH.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DRm4OVlH.js";
import { i as listRouteBindings } from "./bindings-D5QP1pSA.js";
import { a as formatSetExplicitDefaultToConfiguredInstruction, i as formatSetExplicitDefaultInstruction, r as formatChannelAccountsDefaultPath } from "./routing-B37UwRwq.js";
import { D as resolveSandboxScope, M as DEFAULT_SANDBOX_BROWSER_IMAGE, P as DEFAULT_SANDBOX_IMAGE } from "./docker-YL21-mX4.js";
import { l as shouldMoveSingleAccountChannelKey } from "./setup-helpers-CLK_iaLL.js";
import { a as readChannelAllowFromStore } from "./pairing-store-ClZkWB4v.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-DSMJu_ZS.js";
import { C as parseBrowserMajorVersion, T as resolveGoogleChromeExecutableForPlatform, at as resolveConfiguredSecretInputWithFallback, w as readBrowserVersion } from "./routes-CdaHRCET.js";
import { n as logConfigUpdated } from "./logging-CSCaAwMS.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./config-runtime-ST43sCMq.js";
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-CnHOQpyv.js";
import { n as normalizeTelegramAllowFromEntry, t as isNumericTelegramUserId } from "./allow-from-CUt4UVeA.js";
import { a as listInterpreterLikeSafeBins, s as resolveMergedSafeBinProfileFixtures } from "./exec-inline-eval-BXBKoGM8.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-BYcKChcy.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-PSAQEKfx.js";
import { a as detectLegacyMatrixState, i as autoMigrateLegacyMatrixState, n as hasPendingMatrixMigration, o as autoPrepareLegacyMatrixCrypto, r as maybeCreateMatrixMigrationSnapshot, s as detectLegacyMatrixCrypto, t as hasActionableMatrixMigration } from "./matrix-migration-snapshot-Bh6wmCNN.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DRcU24uZ.js";
import { r as buildPluginCompatibilityWarnings } from "./status-DE_JvlNY.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-BRcIzvG0.js";
import { t as note$1 } from "./note-DFCwFXVH.js";
import { r as healthCommand } from "./health-CQB6nHmz.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-8FlHCc2H.js";
import { m as normalizeStoredCronJobs, n as runGatewayUpdate, t as runStartupMatrixMigration, v as detectPluginInstallPathIssue, y as formatPluginInstallPathIssue } from "./server-startup-matrix-migration-C0IPDzxT.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CoDKTdlM.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-jLdnZwhv.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DmGBYuE6.js";
import { t as formatHealthCheckFailure } from "./health-format-iTKKzkTr.js";
import { n as doctorShellCompletion } from "./doctor-completion-jlof7tfI.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-BoKzmjiQ.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-BYekwdAx.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-BKd7vVXB.js";
import { i as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./doctor-state-migrations-d_Jifqak.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-D6gm0sgb.js";
