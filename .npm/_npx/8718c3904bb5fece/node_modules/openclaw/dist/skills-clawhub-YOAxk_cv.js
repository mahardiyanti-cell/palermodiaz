import { r as fileExists } from "./archive-Bk8HKpaY.js";
import { l as resolveClawHubBaseUrl, o as fetchClawHubSkillDetail, p as searchClawHubSkills, r as downloadClawHubSkillArchive, s as listClawHubSkills } from "./clawhub-xVLMmaOX.js";
import { n as resolveSafeInstallDir } from "./install-safe-path-YEwOfkn7.js";
import { i as withExtractedArchiveRoot, t as installPackageDir } from "./install-package-dir-Di2gGBfU.js";
...
async function searchSkillsFromClawHub(params) {
	if (params.query?.trim()) return await searchClawHubSkills({
		query: params.query,
		limit: params.limit,
		baseUrl: params.baseUrl
	});
	return (await listClawHubSkills({
		limit: params.limit,
		baseUrl: params.baseUrl
	})).items.map((item) => ({
		score: 0,
