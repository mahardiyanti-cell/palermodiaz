...
import { U as listRiskyConfiguredSafeBins, V as normalizeTrustedSafeBinDirs } from "./io-cPs4dU7X.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-DiT8-OyD.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-CEN00XrG.js";
import { t as formatCliCommand } from "./command-format-DRptdHvm.js";
import { a as resolveGatewayAuth } from "./auth-C_pTuZtn.js";
import { E as resolveSandboxConfigForAgent } from "./docker-YL21-mX4.js";
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-rHmQXFZ4.js";
import { n as resolveBrowserConfig, r as resolveProfile } from "./config-BkPtspys.js";
import { et as resolveBrowserControlAuth, f as redactCdpUrl } from "./routes-CdaHRCET.js";
import { i as loadExecApprovals } from "./exec-approvals-CVzy3Vfp.js";
import { a as listInterpreterLikeSafeBins, r as isInterpreterLikeAllowlistPattern, s as resolveMergedSafeBinProfileFixtures } from "./exec-inline-eval-BXBKoGM8.js";
import { n as hasPotentialConfiguredChannels } from "./config-presence-CovoxGn8.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DW4DdGOU.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CfvzGiVQ.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-BsqJQjTC.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-DrwRXLVF.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-DgAAWh1w.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-DSIB0qYp.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-XjCI0CPk.js"),
		import("./probe-auth-B5sXpm-T.js"),
		import("./probe-uyAkrEG4.js")
