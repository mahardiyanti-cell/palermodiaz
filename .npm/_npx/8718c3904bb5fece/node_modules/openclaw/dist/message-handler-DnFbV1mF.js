...
import { k as resolveDiscordPreviewStreamMode } from "./zod-schema.providers-core-DLPfih2y.js";
import { t as resolveAccountEntry } from "./account-lookup-De_hUz0X.js";
import { i as readSessionUpdatedAt } from "./store-D_eNuCKK.js";
...
import { Ay as EmbeddedBlockChunker, Fg as hasControlCommand, Gg as resolveEnvelopeFormatOptions, Ht as normalizeDiscordOutboundTarget, Jy as resolveDiscordMaxLinesPerMessage, Mg as resolveMentionGatingWithBypass, Ng as createChannelInboundDebouncer, Or as chunkDiscordTextWithMode, Pg as shouldDebounceTextInbound, Qg as dispatchInboundMessage, Qt as reactMessageDiscord, Ug as formatInboundEnvelope, _n as sendPollDiscord, ar as isDiscordGroupAllowedByPolicy, bg as recordChannelActivity, bn as sendWebhookMessageDiscord, br as resolveTimestampMs, di as Routes, dr as resolveDiscordMemberAccessState, en as removeReactionDiscord, fr as resolveDiscordOwnerAccess, gn as sendMessageDiscord, hr as resolveGroupDmAllow, in as sendDiscordComponentMessage, lr as resolveDiscordChannelConfigWithFallback, mr as resolveDiscordShouldRequireMention, pn as buildDiscordInteractiveComponents, r_ as createReplyDispatcherWithTyping, ri as ChannelType, si as MessageType, sr as normalizeDiscordSlug, ur as resolveDiscordGuildEntry, vr as formatDiscordUserTag, wn as editMessageDiscord, yr as resolveDiscordSystemLocation, zt as fetchPluralKitMessageInfo } from "./pi-embedded-CzQCqSlH.js";
import { t as buildAgentSessionKey } from "./resolve-route-DbP_XX4E.js";
import { r as resolveOutboundSendDep } from "./outbound-runtime-oDjCAP7B.js";
import { S as resolveTextChunkLimit, T as stripReasoningTagsFromText, u as convertMarkdownTables, x as resolveChunkMode } from "./text-runtime-B9_24WY5.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-CIys7o93.js";
import { i as resolveOpenProviderRuntimeGroupPolicy } from "./runtime-group-policy-BoqLmPvt.js";
import { W as getSessionBindingService, c as ensureConfiguredBindingRouteReady, j as isPluginOwnedSessionBindingRecord, l as resolveConfiguredBindingRoute, s as recordInboundSession } from "./conversation-runtime-CqOm9f5F.js";
import { i as createAttachedChannelResultAdapter, t as attachChannelToResult } from "./channel-send-result-BUHt3vEX.js";
import { n as buildPairingReply } from "./pairing-challenge-UlRRyPQ2.js";
import { u as resolveControlCommandGate } from "./dm-policy-shared-DSMJu_ZS.js";
import { b as sendTextMediaPayload, f as resolvePayloadMediaUrls, p as resolveSendableOutboundReplyParts, v as sendPayloadMediaSequenceOrFallback } from "./reply-payload-MXtGsVoh.js";
...
import { a as createStatusReactionController, d as logInboundDrop, f as logTypingFailure, r as DEFAULT_TIMING, u as logAckFailure } from "./channel-feedback-n64lXuo0.js";
...
async function resolveDiscordPreflightAudioMentionContext(params) {
	...
	if (needsPreflightTranscription) {
		...
		try {
			const { transcribeFirstAudio } = await import("./preflight-audio.runtime-Ca8M-3a0.js");
			if (params.abortSignal?.aborted) return {
				hasAudioAttachment,
				hasTypedText
			};
