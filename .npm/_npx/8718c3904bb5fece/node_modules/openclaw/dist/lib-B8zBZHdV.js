...
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-lzUhZhEN.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-Z68SvyWn.js";
import { l as toRatio, n as decodeString } from "./Util-DIl_aXJ4.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CXRZwCAe.js";
import { t as APEv2Parser } from "./APEv2Parser-BjAUATR-.js";
import { r as hasID3v1Header } from "./ID3v1Parser-Ct77hTtp.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-B_I-6TnD.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-Bj8NyLF7.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-D5_Mmt6r.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-CuozfycW.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-CNqaaf1B.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DIQg9nhg.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CSL58pxj.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-Dzk_slJ5.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-y8aGtzD4.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DkXGD6X-.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-N4B9gPMn.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-Bg6uOgn9.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-CmxWlLVc.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BYLOpv-l.js")).WaveParser;
	}
};
//#endregion
