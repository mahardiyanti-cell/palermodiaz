...
import { a as resolveAgentDir, p as resolveAgentWorkspaceDir, v as resolveSessionAgentId } from "./agent-scope-DoT9OqaV.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CyhDhBAD.js";
import { S as resolveThinkingDefault } from "./model-selection-B6ao45a4.js";
import { g as writeConfigFile, s as loadConfig } from "./io-cPs4dU7X.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-D5E7Gxgl.js";
import { a as recordSessionMetaFromInbound, c as updateLastRoute, i as readSessionUpdatedAt, n as loadSessionStore, s as saveSessionStore } from "./store-D_eNuCKK.js";
import { f as onSessionTranscriptUpdate } from "./sessions-C8WesgCl.js";
import { l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BPfguEtH.js";
import { t as registerMemoryCli } from "./memory-cli-PrIR2Lrr.js";
import { i as resolveHumanDelayConfig, n as resolveAgentIdentity, r as resolveEffectiveMessagesConfig } from "./identity-D8H54Ni5.js";
import { $i as pushMessageLine, D as telegramMessageActions, Fg as hasControlCommand, Fh as resolveTelegramToken, Gg as resolveEnvelopeFormatOptions, Hg as formatAgentEnvelope, Lg as isControlCommandMessage, Ni as monitorLineProvider, Pi as buildTemplateMessageFromPayload, Qi as pushLocationMessage, Rc as onAgentEvent, Rg as shouldComputeCommandAuthorized, Sl as signalMessageActions, T as setTelegramThreadBindingMaxAgeBySessionKey, Ua as listWebSearchProviders, Ug as formatInboundEnvelope, Wa as runWebSearch, Xi as createQuickReplyItems, Zi as pushFlexMessage, __ as resolveInboundDebounceMs, a_ as dispatchReplyFromConfig, aa as normalizeAccountId, bg as recordChannelActivity, bu as listRuntimeImageGenerationProviders, dc as dispatchReplyWithBufferedBlockDispatcher, ea as pushMessagesLine, g_ as createInboundDebouncer, hf as requestHeartbeatNow, ia as listLineAccountIds, ic as sendMessageSignal, ji as probeLineBot, na as pushTextMessageWithQuickReplies, nc as probeSignal, oa as resolveDefaultLineAccountId, r_ as createReplyDispatcherWithTyping, ra as sendMessageLine, rc as monitorSignalProvider, sa as resolveLineAccount, t_ as withReplyDispatcher, ta as pushTemplateMessage, th as isVoiceCompatibleAudio, w as setTelegramThreadBindingIdleTimeoutBySessionKey, yg as getChannelActivity, yu as generateImage } from "./pi-embedded-CzQCqSlH.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DRm4OVlH.js";
import { i as resolveAgentRoute, t as buildAgentSessionKey } from "./resolve-route-DbP_XX4E.js";
import { S as resolveTextChunkLimit, _ as chunkMarkdownText, b as chunkTextWithMode, h as chunkByNewline, u as convertMarkdownTables, v as chunkMarkdownTextWithMode, x as resolveChunkMode, y as chunkText } from "./text-runtime-B9_24WY5.js";
import { c as jsonResult, d as readNumberParam, h as readStringParam } from "./common-De-BVwIv.js";
import { c as resizeToJpeg, i as getImageMetadata } from "./image-ops-BLXW6hKm.js";
import { m as mediaKindFromMime, t as detectMime } from "./mime-D7Q9o2pi.js";
import { x as resolveAgentTimeoutMs } from "./manager-CTkU8M9E.js";
import { s as recordInboundSession } from "./conversation-runtime-CqOm9f5F.js";
import { a as logWebSelfId, b as shouldPreferNativeJiti, c as monitorWebChannel, d as sendPollWhatsApp, f as startWebLoginWithQr, g as buildPluginLoaderJitiOptions, i as handleWhatsAppAction, l as readWebSelfId, m as webAuthExists, n as getActiveWebListener, o as loginWeb, p as waitForWebLogin, r as getWebAuthAgeMs, s as logoutWeb, t as createRuntimeWhatsAppLoginTool, u as sendMessageWhatsApp, v as resolvePluginSdkAliasFile, y as resolvePluginSdkScopedAliasMap } from "./runtime-whatsapp-boundary-CWceJs-_.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-ClZkWB4v.js";
import { n as buildPairingReply } from "./pairing-challenge-UlRRyPQ2.js";
import { l as resolveCommandAuthorizedFromAuthorizers } from "./dm-policy-shared-DSMJu_ZS.js";
import { E as finalizeInboundContext } from "./templating-BueU7auS.js";
import { f as buildMentionRegexes, m as matchesMentionWithExplicit, p as matchesMentionPatterns } from "./reply-history-BVE7m0XA.js";
import { y as shouldHandleTextCommands } from "./commands-registry-C-vLUx3f.js";
import { P as saveMediaBuffer } from "./routes-CdaHRCET.js";
import { a as resolveChannelGroupPolicy, l as resolveMarkdownTableMode, o as resolveChannelGroupRequireMention } from "./config-runtime-ST43sCMq.js";
import { r as enqueueSystemEvent } from "./system-events-D9mayVHC.js";
import { a as createLazyRuntimeSurface, n as createLazyRuntimeMethodBinder, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "./lazy-runtime-szmmmzbU.js";
import { l as fetchRemoteMedia, t as loadWebMedia } from "./web-media-C4M86664.js";
import { n as shouldAckReaction, t as removeAckReactionAfterReply } from "./ack-reactions-DgOXBJlx.js";
import { n as collectTelegramUnmentionedGroupIds } from "./audit-CO95QNfX.js";
...
import { a as setThreadBindingMaxAgeBySessionKey, i as setThreadBindingIdleTimeoutBySessionKey, l as getThreadBindingManager, o as unbindThreadBindingsBySessionKey } from "./thread-bindings-r8BO6n9H.js";
import { n as sendMessageIMessage, r as probeIMessage, t as monitorIMessageProvider } from "./imessage-CSS2xDUy.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("./runtime-embedded-pi.runtime-BKyY-QNp.js"));
...
const bindDiscordRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-discord-ops.runtime-D3hWc9WJ.js"), ({ runtimeDiscordOps }) => runtimeDiscordOps));
...
const bindSlackRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-slack-ops.runtime-YUevX0bx.js"), ({ runtimeSlackOps }) => runtimeSlackOps));
...
const bindTelegramRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-telegram-ops.runtime-z1A3XKOs.js"), ({ runtimeTelegramOps }) => runtimeTelegramOps));
...
async function loadMemoryToolRuntime() {
	memoryToolRuntimePromise ??= import("./memory-tool.runtime-Blwi7LkP.js");
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("./runtime-tts.runtime-CBpMJD99.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-media-understanding.runtime-CNDdEPrn.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime-C8HqVdea.js"));
