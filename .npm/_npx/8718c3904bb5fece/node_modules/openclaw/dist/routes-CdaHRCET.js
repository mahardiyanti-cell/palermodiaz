...
import { a as getRuntimeConfigSnapshot, g as writeConfigFile, i as createConfigIO, s as loadConfig } from "./io-cPs4dU7X.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-DiT8-OyD.js";
import { u as secretRefKey } from "./ref-contract-CJXmIbG8.js";
import { o as resolveSecretRefValues } from "./resolve-uXRpJb-M.js";
import { t as formatCliCommand } from "./command-format-DRptdHvm.js";
import { t as assertExplicitGatewayAuthModeWhenBothConfigured } from "./auth-mode-policy-CVVi4ED4.js";
import { r as isLoopbackHost } from "./net-Dk658jWW.js";
import { a as resolveGatewayAuth } from "./auth-C_pTuZtn.js";
import { c as hasGatewayPasswordEnvCandidate, d as readGatewayTokenEnv, l as hasGatewayTokenEnvCandidate } from "./credentials-CO55Yx_u.js";
import { t as rawDataToString } from "./ws-Cuj7iyVm.js";
import { r as ensurePortAvailable } from "./ports-CQIuVpXl.js";
import { t as generateSecureToken } from "./secure-random-B7ebDTuw.js";
import { c as resizeToJpeg, i as getImageMetadata, n as buildImageResizeSideGrid, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-BLXW6hKm.js";
import { n as extensionForMime, t as detectMime } from "./mime-D7Q9o2pi.js";
import { r as hasProxyEnvConfigured } from "./proxy-env-Don_XKXT.js";
import { d as resolvePinnedHostnameWithPolicy, l as isPrivateNetworkAllowedByPolicy, t as SsrFBlockedError, u as resolvePinnedHostname } from "./ssrf-rHmQXFZ4.js";
import { a as openFileWithinRoot, c as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-Dvzkbqib.js";
import { a as allocateColor, c as isValidProfileName, d as DEFAULT_AI_SNAPSHOT_MAX_CHARS, i as allocateCdpPort, l as deriveDefaultBrowserCdpPortRange, n as resolveBrowserConfig, o as getUsedColors, p as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, r as resolveProfile, s as getUsedPorts, t as parseHttpUrl, u as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./config-BkPtspys.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-D7B1xwD2.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-D7B1xwD2.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-D7B1xwD2.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
