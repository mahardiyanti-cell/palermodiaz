...
import { a as resolveOpenClawAgentDir, r as resolveAuthStorePathForDisplay } from "./paths-BFl2-hCf.js";
import { T as resolveAuthProfileDisplayLabel, d as resolveProfileUnusableUntilForDisplay, i as clearAuthProfileCooldown, n as resolveAuthProfileOrder, t as resolveAuthProfileEligibility } from "./auth-profiles-CVFpgeL-.js";
...
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir, s as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride } from "./agent-scope-DoT9OqaV.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CyhDhBAD.js";
import { f as parseModelRef, g as resolveDefaultModelForAgent, h as resolveConfiguredModelRef, i as buildModelAliasIndex, l as modelKey, v as resolveModelRefFromString } from "./model-selection-B6ao45a4.js";
import { n as findNormalizedProviderValue, r as normalizeProviderId } from "./provider-id-CeW6X71v.js";
import { f as readConfigFileSnapshotForWrite, i as createConfigIO, m as setRuntimeConfigSnapshot, s as loadConfig } from "./io-cPs4dU7X.js";
import { o as shouldEnableShellEnvFallback, t as getShellEnvAppliedKeys } from "./shell-env-BKuVS72k.js";
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-DiT8-OyD.js";
import { t as parseDurationMs } from "./parse-duration-bHXUj_T0.js";
import { i as resolveSecretRefString } from "./resolve-uXRpJb-M.js";
import { a as upsertAuthProfile, c as ensureAuthProfileStore, i as setAuthProfileOrder, n as listProfilesForProvider, u as loadAuthProfileStoreForRuntime } from "./profiles-Cyg58FCO.js";
import { t as formatCliCommand } from "./command-format-DRptdHvm.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-BPfguEtH.js";
import { d as openUrl } from "./onboard-helpers-Cks5EPpw.js";
import { r as isWSLEnv } from "./wsl-DoeW56DL.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-MhFLSlua.js";
import { r as withProgressTotals } from "./progress-CWxCPcAp.js";
import { B as resolveAwsSdkEnvVarName, F as getCustomProviderApiKey, H as resolveUsableCustomProviderApiKey, L as hasUsableCustomProviderApiKey, Mp as shouldSuppressBuiltInModel, Ny as loadModelCatalog, ft as resolvePluginProviders, gu as resolveCommandSecretRefsViaGateway, jp as resolveModelWithRegistry, po as formatUsageWindowSummary, t as runEmbeddedPiAgent, uo as loadProviderUsageSummary, xu as describeFailoverError, z as resolveApiKeyForProvider } from "./pi-embedded-CzQCqSlH.js";
import { c as resolveEnvApiKey, y as isNonSecretApiKeyMarker } from "./provider-auth-input-DxjPWsSV.js";
import { n as logConfigUpdated } from "./logging-CSCaAwMS.js";
import { S as upsertCanonicalModelConfigEntry, _ as normalizeAlias, b as resolveModelTarget, d as ensureFlagCompatibility, f as formatMs, g as mergePrimaryFallbackConfig, h as loadValidConfigOrThrow, m as isLocalBaseUrl, p as formatTokenK, u as applyDefaultModelPrimaryUpdate, v as resolveKnownAgentId, x as updateConfig, y as resolveModelKeysFromEntries } from "./config-runtime-ST43sCMq.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-BeqTsaJO.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-BpWH93Dy.js";
import { m as resolveUsageProviderId } from "./provider-usage-BWl6XLRe.js";
import { i as getModelsCommandSecretTargetIds } from "./command-secret-targets-BYcKChcy.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-BRcIzvG0.js";
import { t as maskApiKey } from "./mask-api-key-CDGx1IBo.js";
import { t as createClackPrompter } from "./clack-prompter-DKnh22on.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-D77MmWwB.js";
import { n as redactSecrets } from "./format-CBdBGDDR.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-DCbfY_qu.js";
import { i as resolveProviderMatch, n as mergeConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-BeLNIaNI.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-jLdnZwhv.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-DhHao4QL.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-5zmFt2qR.js");
	const { ensureOpenClawModelsJson } = await import("./models-config-BeV4ZXqR.js");
