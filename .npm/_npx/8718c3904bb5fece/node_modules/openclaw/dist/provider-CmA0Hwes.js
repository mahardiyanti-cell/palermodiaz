...
import { a as clearExpiredCooldowns, f as resolveProfilesUnavailableReason, s as isProfileInCooldown } from "./auth-profiles-CVFpgeL-.js";
...
import { r as normalizeProviderId } from "./provider-id-CeW6X71v.js";
import { s as loadConfig } from "./io-cPs4dU7X.js";
import { n as withFileLock } from "./file-lock-DoKDW8jx.js";
import { c as ensureAuthProfileStore } from "./profiles-Cyg58FCO.js";
import { l as normalizeMessageChannel } from "./message-channel-DUrzQUcI.js";
import { i as readSessionUpdatedAt, l as updateSessionStore, n as loadSessionStore } from "./store-D_eNuCKK.js";
...
import { i as resolveHumanDelayConfig } from "./identity-D8H54Ni5.js";
import { $r as ChannelSelectMenu, Ar as TextDisplay, Br as ReadyListener, D_ as addAllowlistUserEntriesFromConfigEntry, Dg as resolveNativeCommandSessionTargets, Fr as InteractionCreateListener, Gg as resolveEnvelopeFormatOptions, Gr as Client, Hr as VoiceServerUpdateListener, Ip as executePluginCommand, Ir as MessageCreateListener, Jr as StringSelectMenu, Jy as resolveDiscordMaxLinesPerMessage, Kr as RateLimitError, Ky as resolveDiscordAccount, Lr as MessageReactionAddListener, M_ as summarizeMapping, Mr as Row, Nr as Modal, O_ as buildAllowlistResolutionSummary, Or as chunkDiscordTextWithMode, Pr as GuildDeleteListener, Qr as Command, Rp as matchPluginCommand, Rr as MessageReactionRemoveListener, Tr as createDiscordClient, Ug as formatInboundEnvelope, Ur as VoiceStateUpdateListener, Vr as ThreadUpdateListener, Wp as getPluginCommandSpecs, Wr as ListenerEvent, Xr as MentionableSelectMenu, Xt as unregisterGateway, Yr as RoleSelectMenu, Yt as registerGateway, Yy as normalizeDiscordToken, Zr as CommandWithSubcommands, _r as formatDiscordReactionEmoji, ai as GatewayIntentBits, ar as isDiscordGroupAllowedByPolicy, ci as ApplicationCommandOptionType, cn as parseDiscordComponentCustomId, cr as resolveDiscordAllowListMatch, dc as dispatchReplyWithBufferedBlockDispatcher, di as Routes, dn as parseDiscordModalCustomIdForCarbon, dr as resolveDiscordMemberAccessState, ei as Button, er as stripUndefinedFields, fc as dispatchReplyWithDispatcher, fg as getExecApprovalApproverDmNoticeText, fr as resolveDiscordOwnerAccess, ga as buildModelsProviderData, gr as shouldEmitDiscordReactionNotification, hn as resolveDiscordModalEntry, hr as resolveGroupDmAllow, ii as GatewayCloseCodes$1, j_ as patchAllowlistUsersInConfigEntries, jr as Container, k_ as canonicalizeAllowlistWithResolvedIds, kr as Separator, li as ButtonStyle, ln as parseDiscordComponentCustomIdForCarbon, lr as resolveDiscordChannelConfigWithFallback, mg as resolveExecApprovalCommandDisplay, mi as setPresence, mn as resolveDiscordComponentEntry, ng as wrapFetchWithAbortSignal, ni as serializePayload, nn as editDiscordComponentMessage, oi as GatewayOpcodes$1, on as createDiscordFormModal, or as normalizeDiscordAllowList, qr as UserSelectMenu, ri as ChannelType, sn as formatDiscordComponentEventText, sr as normalizeDiscordSlug, ti as Plugin, uc as createReplyReferencePlanner, ui as ChannelType$1, un as parseDiscordModalCustomId, ur as resolveDiscordGuildEntry, vr as formatDiscordUserTag, wt as dispatchPluginInteractiveHandler, xn as formatMention, zr as PresenceUpdateListener } from "./pi-embedded-CzQCqSlH.js";
import { i as resolveAgentRoute } from "./resolve-route-DbP_XX4E.js";
import { S as resolveTextChunkLimit, r as chunkItems, t as withTimeout, w as summarizeStringEntries, x as resolveChunkMode } from "./text-runtime-B9_24WY5.js";
import { a as warnMissingProviderGroupPolicyFallbackOnce, i as resolveOpenProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy, t as GROUP_POLICY_BLOCKED_LABEL } from "./runtime-group-policy-BoqLmPvt.js";
import { F as resolvePluginConversationBindingApproval, N as parsePluginBindingApprovalCustomId, T as buildPluginBindingResolvedText, c as ensureConfiguredBindingRouteReady, l as resolveConfiguredBindingRoute, s as recordInboundSession, t as formatThreadBindingDurationLabel } from "./conversation-runtime-CqOm9f5F.js";
import { d as upsertChannelPairingRequest } from "./pairing-store-ClZkWB4v.js";
import { n as writeJsonFileAtomically, t as readJsonFileWithFallback } from "./json-store-Ju23bywi.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-DorwL7gs.js";
import { n as buildPairingReply } from "./pairing-challenge-UlRRyPQ2.js";
import { c as resolvePinnedMainDmOwnerFromAllowlist, l as resolveCommandAuthorizedFromAuthorizers, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists } from "./dm-policy-shared-DSMJu_ZS.js";
import { m as resolveTextChunksWithFallback, p as resolveSendableOutboundReplyParts } from "./reply-payload-MXtGsVoh.js";
import { E as finalizeInboundContext } from "./templating-BueU7auS.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-C0iCnI2R.js";
import { c as listChatCommands, d as listNativeCommandSpecsForConfig, g as resolveCommandArgMenu, h as resolveCommandArgChoices, m as parseCommandArgs, n as buildCommandTextFromArgs, r as findCommandByNativeName, v as serializeCommandArgs } from "./commands-registry-C-vLUx3f.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DDonxE3L.js";
import { o as resolveStoredModelOverride } from "./level-overrides-DoL5t4pG.js";
import { l as resolveMarkdownTableMode } from "./config-runtime-ST43sCMq.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-CnHOQpyv.js";
import { i as formatDurationSeconds } from "./format-duration-PnUDQ_ov.js";
import { r as enqueueSystemEvent } from "./system-events-D9mayVHC.js";
import { o as getAgentScopedMediaLocalRoots, t as loadWebMedia } from "./web-media-C4M86664.js";
import { n as createConnectedChannelStatusPatch, t as createOperatorApprovalsGatewayClient } from "./gateway-runtime-DhcHrysu.js";
import { a as createArmableStallWatchdog } from "./channel-lifecycle-CUIlKgWN.js";
import { S as resolveDiscordChannelInfo, a as handleDiscordDmCommandDecision, f as deliverDiscordReply, g as resolveDiscordSenderIdentity, i as resolveDiscordEffectiveRoute, m as buildGuildLabel, n as resolveDiscordBoundConversationRoute, o as resolveDiscordDmCommandAccess, p as buildDirectLabel, s as sendTyping, u as resolveDiscordThreadParentInfo, v as buildDiscordGroupSystemPrompt, y as buildDiscordInboundAccessContext } from "./route-resolution-CRjhQ-X0.js";
import { a as isThreadArchived } from "./thread-bindings.messages-TP9SUuUL.js";
import { a as runDiscordTaskWithTimeout, i as normalizeDiscordListenerTimeoutMs } from "./timeouts-DqgpCWVw.js";
import { n as fetchDiscordApplicationId, t as DiscordUiContainer } from "./ui-Ct7fSJa7.js";
import { t as require_src } from "./src-PBF8suXB.js";
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-yjbm5KZ9.js");
	return await discordVoiceRuntimePromise;
}
async function loadDiscordProviderSessionRuntime() {
	discordProviderSessionRuntimePromise ??= import("./provider-session.runtime-DslyMskV.js");
