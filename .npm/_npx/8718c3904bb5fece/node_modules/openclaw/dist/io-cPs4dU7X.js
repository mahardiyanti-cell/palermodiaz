...
import { m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-DoT9OqaV.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-CyhDhBAD.js";
import { f as parseModelRef } from "./model-selection-B6ao45a4.js";
import { r as normalizeProviderId } from "./provider-id-CeW6X71v.js";
import { i as normalizeEnvVarKey, n as isDangerousHostEnvOverrideVarName, r as isDangerousHostEnvVarName } from "./host-env-security-DEKL50zA.js";
import { a as shouldDeferShellEnvFallback, i as resolveShellEnvFallbackTimeoutMs, o as shouldEnableShellEnvFallback, r as loadShellEnvFallback } from "./shell-env-BKuVS72k.js";
import { t as sanitizeTerminalText } from "./safe-text-DIDDfQyI.js";
import { n as VERSION } from "./version-BpHNkJed.js";
import { a as hasConfiguredSecretInput, i as coerceSecretRef } from "./types.secrets-DiT8-OyD.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-B8NFl2Jd.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-CCK6fRRs.js";
import { A as resolveSlackNativeStreaming, D as formatSlackStreamingBooleanMigrationMessage, E as formatSlackStreamModeMigrationMessage, M as resolveTelegramPreviewStreamMode, T as ChannelHeartbeatVisibilitySchema, a as IrcConfigSchema, c as SlackConfigSchema, i as IMessageConfigSchema, j as resolveSlackStreamingMode, k as resolveDiscordPreviewStreamMode, l as TelegramConfigSchema, n as DiscordConfigSchema, o as MSTeamsConfigSchema, r as GoogleChatConfigSchema, s as SignalConfigSchema, t as BlueBubblesConfigSchema, w as ChannelHealthMonitorSchema } from "./zod-schema.providers-core-DLPfih2y.js";
import { a as ensureAgentEntry, c as getRecord, d as resolveDefaultAgentIdFromRaw, l as mapLegacyAudioTranscription, o as ensureRecord, r as normalizeLegacyWebSearchConfig, s as getAgentsList, t as listLegacyWebSearchConfigPaths, u as mergeMissing } from "./legacy-web-search-CTvir-Bl.js";
import { t as splitShellArgs } from "./shell-argv-DedwspM6.js";
import { c as normalizeChatChannelId, l as CHANNEL_IDS } from "./registry-xyHjVLxh.js";
import { a as resolveEffectiveEnableState, i as normalizePluginsConfig, o as resolveMemorySlotDecision } from "./config-state-Dx9-tLPS.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-D5E7Gxgl.js";
import { c as isWindowsAbsolutePath, i as isAvatarHttpUrl, n as hasAvatarUriScheme, o as isPathWithinRoot, r as isAvatarDataUrl } from "./avatar-policy-DVf9B9eu.js";
import { i as isCanonicalDottedDecimalIPv4, u as isLoopbackIpAddress } from "./ip-DIgtRRTW.js";
import { t as parseDurationMs } from "./parse-duration-bHXUj_T0.js";
import { a as MemorySearchSchema, c as AgentModelSchema, i as HeartbeatSchema, n as AgentSandboxSchema, o as ToolPolicySchema, r as ElevatedAllowFromSchema, s as ToolsSchema, t as AgentEntrySchema } from "./zod-schema.agent-runtime-C659GPl8.js";
import { A as TtsConfigSchema, I as sensitive, L as createAllowDenyChannelRulesSchema, N as TypingModeSchema, O as TranscribeAudioSchema, S as SecretInputSchema, T as SecretsConfigSchema, a as DmPolicySchema, c as GroupPolicySchema, f as InboundDebounceSchema, g as NativeCommandsSettingSchema, h as ModelsConfigSchema, i as DmConfigSchema, l as HexColorSchema, m as MarkdownConfigSchema, n as BlockStreamingCoalesceSchema, r as CliBackendSchema, s as GroupChatSchema, t as BlockStreamingChunkSchema, u as HumanDelaySchema, v as QueueSchema } from "./zod-schema.core-yLTNC4-K.js";
...
function finalizeExecWrapperTrustPlan(argv, wrapperChain, policyBlocked, blockedWrapper) {
...
//#endregion
export { splitCommandChainWithOperators as $, getConfigOverrides as A, normalizeTalkSection as At, listWritableExplicitTrustedSafeBinDirs as B, parseNonNegativeByteSize as C, applyMergePatch as Ct, withBundledPluginAllowlistCompat as D, createConfigRuntimeEnv as Dt, listBundledWebSearchPluginIds as E, collectDurableServiceEnvVars as Et, parseConfigPath as F, analyzeArgvCommand as G, validateSafeBinArgv as H, setConfigValueAtPath as I, buildSafeBinsShellCommand as J, analyzeShellCommand as K, unsetConfigValueAtPath as L, setConfigOverride as M, resolveAgentMaxConcurrent as Mt, unsetConfigOverride as N, resolveSubagentMaxConcurrent as Nt, withBundledPluginEnablementCompat as O, DEFAULT_TALK_PROVIDER as Ot, getConfigValueAtPath as P, resolveOwnerDisplaySetting as Pt, splitCommandChain as Q, getTrustedSafeBinDirs as R, WhatsAppConfigSchema as S, resolveSafeBinProfiles as St, validateJsonSchemaValue as T, ensureControlUiAllowedOriginsForNonLoopbackBind as Tt, listRiskyConfiguredSafeBins as U, normalizeTrustedSafeBinDirs as V, normalizeSafeBinName as W, isWindowsPlatform as X, buildSafeShellCommand as Y, resolvePlannedSegmentArgv as Z, validateConfigObject as _, unwrapKnownDispatchWrapperInvocation as _t, getRuntimeConfigSnapshot as a, resolveExecutableFromPathEnv as at, validateConfigObjectWithPlugins as b, SAFE_BIN_PROFILES as bt, parseConfigJson5 as c, extractShellWrapperCommand as ct, readConfigFileSnapshot as d, isShellWrapperExecutable as dt, matchAllowlist as et, readConfigFileSnapshotForWrite as f, unwrapKnownShellMultiplexerInvocation as ft, writeConfigFile as g, unwrapDispatchWrappersForResolution as gt, setRuntimeConfigSnapshotRefreshHandler as h, resolveInlineCommandMatch as ht, createConfigIO as i, resolveCommandResolutionFromArgv as it, resetConfigOverrides as j, resolveActiveTalkProviderConfig as jt, applyConfigOverrides as k, buildTalkConfigResponse as kt, projectConfigOntoRuntimeSourceSnapshot as l, extractShellWrapperInlineCommand as lt, setRuntimeConfigSnapshot as m, POWERSHELL_INLINE_COMMAND_FLAGS as mt, clearConfigCache as n, resolveAllowlistCandidatePath as nt, getRuntimeConfigSourceSnapshot as o, resolveExecWrapperTrustPlan as ot, resolveConfigSnapshotHash as p, POSIX_INLINE_COMMAND_FLAGS as pt, buildEnforcedShellCommand as q, clearRuntimeConfigSnapshot as r, resolveCommandResolution as rt, loadConfig as s, POSIX_SHELL_WRAPPERS as st, ConfigRuntimeRefreshError as t, parseExecArgvToken as tt, readBestEffortConfig as u, hasEnvManipulationBeforeShellWrapper as ut, validateConfigObjectRaw as v, normalizeExecutableToken as vt, parseByteSize as w, applyLegacyMigrations as wt, OpenClawSchema as x, normalizeSafeBinProfileFixtures as xt, validateConfigObjectRawWithPlugins as y, DEFAULT_SAFE_BINS as yt, isTrustedSafeBinPath as z };
