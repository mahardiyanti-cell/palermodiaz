...
import { s as isValidEnvSecretRefId } from "./types.secrets-DiT8-OyD.js";
import { t as assertSupportedRuntime } from "./runtime-guard-QGt7fm0l.js";
...
import "./daemon-runtime-BVpor8un.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-Cks5EPpw.js";
...
import { t as runSetupWizard } from "./setup-BHYIVag7.js";
import { i as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-DH43D9k3.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-BxMo9ATY.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-CupvPk4m.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-CJc5HhBl.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-qsl7RQUw.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-B04tyGMi.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CpL5u7Du.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-Csmda_HO.js");
