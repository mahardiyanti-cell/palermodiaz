...
import { a as hasConfiguredSecretInput } from "./types.secrets-DiT8-OyD.js";
import { Dv as createAllowlistProviderGroupPolicyWarningCollector, F_ as createChatChannelPlugin, H_ as adaptScopedAccountAccessor, Lv as projectConfigAccountIdWarningCollector, N_ as buildChannelOutboundSessionRoute, R_ as stripChannelTargetPrefix, U_ as createHybridChannelConfigAdapter, x_ as formatAllowFromLowercase } from "./pi-embedded-CzQCqSlH.js";
...
import { i as createActionGate } from "./common-De-BVwIv.js";
import { n as createMessageToolCardSchema } from "./channel-actions-BzT1SAu9.js";
...
import { i as buildProbeChannelStatusSummary, l as createComputedAccountStatusAdapter, u as createDefaultChannelRuntimeState } from "./status-helpers-Dd-hr4j4.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-DorwL7gs.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-Bx9-onS0.js";
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-szmmmzbU.js";
import { p as createChannelDirectoryAdapter } from "./directory-runtime-Dv9ukfmB.js";
import { _ as feishuSetupAdapter, a as feishuSetupWizard, c as createFeishuClient, f as listEnabledFeishuAccounts, g as resolveFeishuCredentials, h as resolveFeishuAccount, i as parseFeishuConversationId, m as resolveDefaultFeishuAccountId, p as listFeishuAccountIds } from "./feishu-Iku76BpW.js";
import { i as normalizeFeishuTarget, r as looksLikeFeishuId, t as getFeishuRuntime } from "./runtime-Dsqow0jd.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-CBFI6rcQ.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-C98bwlHW.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-9vNoEL31.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-wOil5jvb.js");
			const account = resolveFeishuAccount({
				cfg: ctx.cfg,
